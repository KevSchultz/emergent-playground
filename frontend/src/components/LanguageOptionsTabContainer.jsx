  ...
  return (
    <Box>
      ...
      <ResizableGrid limit={400}>
        <Button variant="outlined" onClick={handleViewShader} fullWidth>
          View Full Shader
        </Button>
        <Button variant="outlined" onClick={handleCompile} fullWidth>
          Compile
        </Button>
      </ResizableGrid>
      <AceEditor
