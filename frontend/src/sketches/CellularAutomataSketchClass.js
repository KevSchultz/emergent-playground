...
class CellularAutomataSketchClass {
  ...
  constructor(defaultReactProperties) {
    ...
    this.reactP5WrapperToClassInterface =
      this.reactP5WrapperToClassInterface.bind(this);
    ...
    this.setupPreviousStateGraphicsBuffer =
      this.setupPreviousStateGraphicsBuffer.bind(this);
    ...
    this.screenToWorldP52DCoordinates =
      this.screenToWorldP52DCoordinates.bind(this);
    this.screenToWorldP5WebGlCoordinates =
      this.screenToWorldP5WebGlCoordinates.bind(this);
    ...
    this.debugMode
      ? console.log("CellularAutomataSketchClass.constructor")
      : null;
  }
  ...
  updateWorldWidth(newWorldWidth) {
    ...
    this.overlayGraphics.resizeCanvas(
      newWorldWidth,
      this.reactProperties.worldHeight,
    );
  ...
  updateShader(newVertexShader, newFragmentShader) {
    ...
    this.debugMode
      ? console.log("CellularAutomataSketchClass.updateShader")
      : null;
  }
  ...
  reactP5WrapperToClassInterface(p5) {
    ...
    this.debugMode
      ? console.log(
          "CellularAutomataSketchClass.reactP5WrapperToClassInterface",
        )
      : null;
  }
  ...
  updateReactProperties(newReactProperties) {
    ...
    if (
      ...
      this.updateShader(
        newReactProperties.vertexShader,
        newReactProperties.fragmentShader,
      );
    }
  ...
  setupMainCanvas() {
    ...
    this.debugMode
      ? console.log("CellularAutomataSketchClass.setupMainCanvas")
      : null;
  }
  ...
  setupCurrentStateGraphicsBuffer(worldWidth, worldHeight) {
    ...
    this.debugMode
      ? console.log(
          "CellularAutomataSketchClass.setupCurrentStateGraphicsBuffer",
        )
      : null;
  }
  ...
  setupPreviousStateGraphicsBuffer(worldWidth, worldHeight) {
    ...
    this.debugMode
      ? console.log(
          "CellularAutomataSketchClass.setupPreviousStateGraphicsBuffer",
        )
      : null;
  }
  ...
  setupShader(vertexShader, fragmentShader) {
    ...
    this.debugMode
      ? console.log("CellularAutomataSketchClass.setupShader")
      : null;
  }
  ...
  pixelDrawOnGraphics(graphicsBuffer, x, y, color) {
    ...
    this.debugMode
      ? console.log("CellularAutomataSketchClass.pixelDrawOnGraphics")
      : null;
  }
  ...
  squareDrawOnGraphics(graphicsBuffer, x, y, color, size) {
    ...
    this.debugMode
      ? console.log("CellularAutomataSketchClass.squareDrawOnGraphics")
      : null;
  }
  ...
  circleDrawOnGraphics(graphicsBuffer, x0, y0, color, diameter) {
    ...
    this.debugMode
      ? console.log("CellularAutomataSketchClass.circleDrawOnGraphics")
      : null;
  }
   ...
   */
  copyGraphicsBufferImageDataToAnotherGraphicsBuffer(
    source,
    destination,
    x,
    y,
  ...
  mouseWheel(event) {
    ...
    this.debugMode
      ? console.log("CellularAutomataSketchClass.mouseWheel")
      : null;
  }
  ...
  mouseDragged() {
    ...
    this.reactProperties.setCameraX((previousCameraX) => {
      if (
        ...
        (this.p5.mouseButton === this.p5.LEFT &&
          this.p5.keyIsDown(this.p5.SHIFT))
      ) {
        console.log("MOVE");
    ...
    this.debugMode
      ? console.log("CellularAutomataSketchClass.mouseDragged")
      : null;
  }
  ...
  mousePressed() {
    ...
    if (
      this.cursorIsOnWorld() &&
      this.reactProperties.continuousPlay == false
    ) {
      this.reactProperties.setPause(1);
    }

    this.debugMode
      ? console.log("CellularAutomataSketchClass.mousePressed")
      : null;
  }
  ...
  windowResized() {
    ...
    this.debugMode
      ? console.log("CellularAutomataSketchClass.windowResized")
      : null;
  }
  ...
  screenToWorldP52DCoordinates(screenX, screenY) {
    ...
    let scaledWorldWidth =
      this.reactProperties.worldWidth * this.reactProperties.zoom;
    let scaledWorldHeight =
      this.reactProperties.worldHeight * this.reactProperties.zoom;
   ...
   */
  cursorIsOnWorld() {
    let cursorWorld = this.screenToWorldP52DCoordinates(
      this.p5.mouseX,
      this.p5.mouseY,
    );
    return (
      cursorWorld.x !== null && cursorWorld.y !== null && this.cursorIsOnCanvas
    );
  }
