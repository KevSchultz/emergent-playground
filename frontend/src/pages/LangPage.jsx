                ...
                <Grid container>
                    <Grid item xs={12} md={12}>
                        <NavBar>
                            ...
                            <Button variant="contained" color="error" onClick={handleCompile}>
                                Compile
                            </Button>
                            <Button variant="contained" color="error" onClick={handleChangeSketch}>
                                Change Sketch
                            </Button>
                        </NavBar>
                    </Grid>
                    <Grid item xs={1}>
                        <ButtonPanel sketch={sketches[sketchIndex]}></ButtonPanel>
                    </Grid>
                    <Grid item xs={11}>
                        <Box
                            style={{
