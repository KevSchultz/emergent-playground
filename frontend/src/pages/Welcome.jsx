            ...
            >
                ...
                >
                    <ButtonBase onClick={navigateRoot}>
                        ...
                        >
                            <img src={Logo} alt="Emergent Playground Logo" style={{ width: '50%' }} />
                    ...
                    >
                        <div style={{ textAlign: 'center' }}>
                            ...
                            >
                                ...
                                cells, each governed by simple rules dictating their state changes
                                based on neighboring cells. These rules typically involve
                                replication, destruction, or state transitions, leading to dynamic
                                and emergent behaviors within the system. Cellular automata find
                                applications in various fields, from generating intricate patterns
                                in art and design to modeling complex phenomena in physics, biology,
                            ...
                            >
                                ...
                                cellular automata. Done over an 8 week period, our team employed
                                SCRUM techniques learned in class to collaborate on this project.
                            </Typography>
